        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                if opt.teacher_weight:
                    ...
                    loss, loss_items = compute_loss(std_pred,targets,stu_feature_adapt(diff_background_std_feature), diff_background_tech_feature.detach(),teacher_loss,training=True)  # loss scaled by batch_size
