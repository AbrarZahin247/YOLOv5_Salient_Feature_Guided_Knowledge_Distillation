...
def compare_two_mask(gt_mask, pred_mask, device):
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                if opt.teacher_weight:
                    ...
                    tech_pred_mask=prepare_batch_mask_tensor(tensor_batch_index, tensor_bbox, batch_size, img_w, img_h, device)
                    
                    teacher_focused_feature_index=compare_two_mask(gt_mask, tech_pred_mask, device)
                    
                    

                    loss, loss_items = compute_loss(std_pred,targets,stu_feature_adapt(diff_background_std_feature), diff_background_tech_feature.detach(),teacher_focused_feature_index)  # loss scaled by batch_size
