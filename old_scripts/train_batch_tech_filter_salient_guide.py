...
from utils.loss_batch_tf import ComputeLoss
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                if opt.teacher_weight:
                    ...
                    sgm_std_feature=std_features-std_features_masked
                    ...
                    sgm_tech_feature=tech_features-tech_features_masked
                    ...
                    loss, loss_items = compute_loss(std_pred,targets,stu_feature_adapt(sgm_std_feature), sgm_tech_feature.detach(),teacher_loss,training=True)  # loss scaled by batch_size
