        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                if opt.teacher_weight:
                    ...
                    loss, loss_items = compute_loss(std_pred,targets,stu_feature_adapt(sgm_std_feature), sgm_tech_feature.detach(),teacher_focused_feature_index)  # loss scaled by batch_size
